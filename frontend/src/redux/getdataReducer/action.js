...
export const GetData=(obj)=>async(dispatch)=>{
    ...
    try{
        const res=await axios.get("https://ajio-shop-web.onrender.com/products",obj)
...
export const deleteProduct=(id,token)=>async(dispatch)=>{
    ...
    try{
        const res=await axios.delete(`https://ajio-shop-web.onrender.com/products/delete/${id}`,{
            headers:{
                Authorization:token
            }
        })
...
export const addProduct=(obj,token)=>async(dispatch)=>{
    ...
    try{
        const res=await axios.post(`https://ajio-shop-web.onrender.com/products/addproduct`,obj,{
            headers:{
                Authorization:token
            }
        })
...
export const updateProduct=(id,obj,token)=>async(dispatch)=>{
    dispatch({type:DELETE_REQUEST})
    try{
        const res=await axios.patch(`https://ajio-shop-web.onrender.com/products/update/${id}`,obj,{
            headers:{
                Authorization:token
            }
        })
