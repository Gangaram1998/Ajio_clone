...
const AdminSidebar = () => {
  ...
  return (
    <Box  width={"20%"} bg={"gray.50"} minH={"800px"} padding={"20px"}>
        ...
        <Button mt="80px" px={"75px"} color={"white"} bg={"orange"} _hover={{bg:"green",color:"white",border:"1px solid green"}} onClick={()=>navigate("/")}>Home</Button>
        <Button mt="50px" px={"35px"} color={"white"} bg={"orange"} _hover={{bg:"green",color:"white",border:"1px solid green"}} onClick={()=>navigate("/admin/dashboard")}>Admin Dashboard</Button>
