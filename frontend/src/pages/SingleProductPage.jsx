        ...
        <Box width={"80%"} mx={"auto"} padding={"20px"} display={"flex"} height={"750px"} justifyContent={"space-between"} mt={"85px"}>
            ...
            <Box width={"30%"} textAlign={"center"} padding={"20px 10px"} display={"flex"} flexDirection={"column"}>
                ...
                <Box mt="10px" padding={"10px 5px"} display={"flex"} justifyContent={"space-around"}>
                    <Box width={"50px"} height={"50px"} border={"1px solid black"} borderRadius={"50%"} bg={"gray.200"} p={"10px"}>S</Box>
                    <Box width={"50px"} height={"50px"} border={"1px solid black"} borderRadius={"50%"} bg={"gray.200"} p={"10px"}>M</Box>
                    <Box width={"50px"} height={"50px"} border={"1px solid black"} borderRadius={"50%"} bg={"gray.200"} p={"10px"}>L</Box>
                    <Box width={"50px"} height={"50px"} border={"1px solid black"} borderRadius={"50%"} bg={"gray.200"} p={"10px"}>XL</Box>
                </Box>
